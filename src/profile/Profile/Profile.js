...
const Profile = ({ fullName, profession, bio, children, handleName }) => {
  return (
    <div className="container">
      ...
      <div className="" style={{ marginLeft: "320px", marginBottom: "30px" }}>
        <h4 >
          {fullName}
          <Button variant="primary"style={{marginLeft:"20px"}}>S'abonner</Button>
        </h4>
        <h6 style={{ color: "#ACACAC" }}>{profession}</h6>
        <p>{bio}</p>
        <Button type="submit" onMouseOver={() => handleName(fullName)}>
          Button
        </Button>
      </div>
